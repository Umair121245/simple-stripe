          ...
          <div class="container-fluid pe-0">
            ...
            {{--
              <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                ...
                <li class="nav-item">
                  <a class="nav-link me-2" href="{{route('sign_in')}}">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form method="POST" role="form" action="{{ route('login') }}">
                    ...
                    <label>Email</label>
                    <div class="mb-3">
                      <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus class="form-control  @error('email') is-invalid @enderror" placeholder="Email" aria-label="Email" aria-describedby="email-addon">
                            @error('email')
                    ...
                    <div class="mb-3">
                      <input id="password" type="password" aria-label="Password" placeholder="Enter Password" aria-describedby="password-addon" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
