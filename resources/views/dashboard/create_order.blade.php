            ...
            <div class="row">
                <div class="col-md-12 mt-4">
                    <div class="card">
                        ...
                        <form action="{{route('admin.submit.order')}}" method="POST">
                            @csrf
                            <div class=" row m-4">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control rounded" name="amount" id="amount" placeholder="Amount" value="" />
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="payment_gateway" required>
                                        <option value="" selected disabled>Select Payment Gateway Type</option>
                            ...
                            <div class="form-row m-4">
                                <div class="row">
                                    @if($packages)
                                        ...
                                        <div class="col-md-4">
                                            <input type="checkbox" id="pack{{$key}}" name="packages[]" value="{{$package->id}}" />
                            ...
                            <div class="form-row m-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="sales_email" id="sales_email" required="" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
