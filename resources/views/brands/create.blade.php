                        ...
                        @endif
                            ...
                            <div class="row m-4">
                              <div class="form-group col-md-12">
                                  ...
                                  <input type="text" class="form-control rounded" name="name" id="brand" placeholder="Brand Name" value="{{ (isset($brand) ? $brand->name : '')}}" />
                              </div>
                            </div>
                            ...
                            @if(isset($brand))
                                <div class="row m-4">
                                    <div class="form-group col-md-4">
                                        <label for="upload">Preview Upload Image </label>
                                        <a href="{{asset($brand->upload)}}" target="_blank" class="nav-link text-body font-weight-bold px-0">Open Link</a>
                                    </div>
                            ...
                            <div class="row m-4">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="file" class="form-control rounded" name="upload" id="upload" accept=".png,.jpg" @if(!isset($brand)) required @endif>
                                </div>

                            </div> 

                            <div class="form-row m-5" style="display: flex; justify-content: center;">
                                <input type="submit" @if(isset($brand)) value="Update" @else value="Save" @endif  class="btn btn-primary" />
                            </div>
